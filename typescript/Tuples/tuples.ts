...
//tuple Array
let array: [string, number, boolean, number, string]= ['rishi', 45, true,7 , 'onion']//can't pass next value as shows error
console.log('origional', 'array');
//value can only be added by appending type? (optional) with in the same tupled array 

let data: [string, number, boolean, number?]= ['hina', 7, true];
data = ['bia', 6, false,9]
console.log(data)
...
let readonlyTuple:readonly[string, number, number, boolean]= ['ghi', 7, 8, true]//throws error if pass next element
